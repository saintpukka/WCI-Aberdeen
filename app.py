...
start_time = st.time_input("Select journey start time:", value=datetime.strptime("08:00", "%H:%M").time())

if st.button("Calculate Route"):
    travel_details, travel_time = get_best_route(start_postcode, destination_postcodes, final_postcode, start_time)
