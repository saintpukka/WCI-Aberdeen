...
def get_best_route(start_postcode, destination_postcodes, speed_kmh=35, pickup_time=1.5, extra_delay=0.5):
    """Find the best route from start to multiple destinations using postcodes."""
...
if st.button("Calculate Route"):
    travel_details, travel_time = get_best_route(start_postcode, destination_postcodes)
